...
var func = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var filesToRemoveFromList, files, rootFolderSave, updateFileList, localLocations, i, handleDragStart, handleDragEnd, items, undoButton, quitButton, addFolder, skipArea, folderSelect;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          filesToRemoveFromList = [".DS_Store", ".localized", "._data.txt"];
          ...
          updateFileList = function updateFileList(fileList) {
            ...
            files = files.filter(function (item) {
              return !filesToRemoveFromList.includes(item);
            });
